        ...
        <div className="bg-[#1a1c18] rounded-[3rem] p-12 md:p-24 text-center border border-white/5 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <button 
              ...
              className="bg-[#bef264] text-black font-extrabold py-5 px-12 rounded-2xl hover:scale-105 transition-all duration-300 flex items-center gap-3 mx-auto text-lg shadow-[0_0_30px_rgba(190,242,100,0.2)]"
            >
